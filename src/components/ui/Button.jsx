...
const VARIANTS = {
  ...
  secondary:
    'bg-surface-card hover:bg-surface-elevated text-content-primary border border-line hover:border-line-hover active:scale-[0.98]',
  ghost:
    'bg-transparent hover:bg-surface-elevated text-content-secondary hover:text-content-primary active:scale-[0.98]',
  danger:
    'bg-red-600 hover:bg-red-500 text-white shadow-lg shadow-red-500/20 hover:shadow-red-500/30 active:scale-[0.98]',
};
...
const BASE =
  'inline-flex items-center justify-center font-medium transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500/50 focus-visible:ring-offset-2 focus-visible:ring-offset-surface-base';
